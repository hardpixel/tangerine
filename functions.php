...
include 'includes/multi-images/multi-images.php';
...
function register_styles() {
	...
	wp_register_style( 'ubuntu', 'http://fonts.googleapis.com/css?family=Ubuntu:400,300,700&subset=latin,greek-ext,greek,cyrillic,latin-ext,cyrillic-ext', '', '', 'screen' );
	wp_register_style( 'open-sans', 'http://fonts.googleapis.com/css?family=Open+Sans:400,300,700&subset=latin,greek-ext,greek,cyrillic,latin-ext,cyrillic-ext', '', '', 'screen' );
}
...
function register_scripts() {
	wp_register_script( 'jquery', get_template_directory_uri() . '/javascripts/vendor/jquery.js', '', '', false );
	wp_register_script( 'jquery-addons', get_template_directory_uri() . '/javascripts/vendor/jquery.addons.js', '', '', true );
	wp_register_script( 'modernizr', get_template_directory_uri() . '/javascripts/vendor/custom.modernizr.js', '', '', false );
...
function enqueue_scripts() {
	...
	wp_enqueue_script( 'jquery-addons' );
...
if( !function_exists('tangerine_main_menu') ) {
...
function get_analytics_code() {
	if ( get_theme_mod( 'seo_analytics' ) != '' ) {
?>

		<script type="text/javascript">

		  var _gaq = _gaq || [];
		  _gaq.push(['_setAccount', '<?php echo get_theme_mod( 'seo_analytics' ) ?>']);
